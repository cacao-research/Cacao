/**
 * Counter Example - Cacao v2 React Client
 *
 * Copy this to your client/src/App.tsx to test the counter example.
 */

import { CacaoProvider, useSignal, useEvent, useConnectionStatus } from '../../client/src/cacao'
