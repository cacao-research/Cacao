...
This guide covers advanced component development, including JavaScript component compilation and the two-stage loading architecture.

## Component Compilation Architecture

### Two-Stage Loading

Cacao uses a two-stage loading architecture:

1. **Stage 1**: `cacao-core.js` - Defines core functions in the `window.CacaoCore` namespace
2. **Stage 2**: `cacao-components.js` - Auto-generated component registrations

### Compilation Process

The `ComponentCompiler` automatically:
...
By following these guidelines, you can develop components that integrate seamlessly with the Cacao framework.
